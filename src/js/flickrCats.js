export default {
  ...
  getSearchUrl: function (perPage) {
    return `https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=78d6a105e9e4bfefa125cb86fbeba8dd&text=Domestic Shorthair}&format=json&nojsoncallback=1&per_page=${perPage}&page=${this.page}`;
  },
  ...
  render: function (photos) {
    ...
    for (let photo of photoList) {
      ...
      iEl.classList.add("photo-container");
